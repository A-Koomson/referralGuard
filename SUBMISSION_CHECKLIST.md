...
| Solution video (≤ official limit) | **Owner task** | Record using local shot list; public outline in `docs/VIDEO_OUTLINE.md` |
...
1. **Record and upload** the official demo video — see `docs/VIDEO_OUTLINE.md` (public) and your local `VIDEO_RECORDING_PLAN.md` (gitignored).
